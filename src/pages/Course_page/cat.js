...
export default function Cat() {
    ...
    const course={
        ...
        clat:{
            name:'CLAT',
            subheading:'The difficulty level of cracking the CLAT exam can vary depending on individual perspectives and preparation strategies. While some consider it to be one of the easiest examinations, others find certain sections, such as Quantitative Aptitude, to be more challenging. Thorough preparation, time management, and a problem-solving mindset are crucial for success.',
            description:"The Consortium of Law Universities (NLUs) conducts a national-level law entrance exam called as CLAT. The exam is conducted by the Institute of Legal Studies (ILS).",
            criteria_1: "Candidates should clear Class 12 with a minimum 45 per cent aggregate (applicable for candidates belonging to General/ Other Backward Class (OBC)/ Person with Disability (PwD)/ Non-Resident Indian (NRI)/ Person of Indian Origin (PIO)/ Overseas Citizen of India (OCI) category). ",
            criteria_2:" Candidates appearing for their Class 12 board examinations in March/April are also eligible to apply for CLAT 2023 exam. However, such candidates need to produce proof of passing Class 12 or equivalent exam at the time of admission.",
            criteria_3:"There is no upper age limit to appear for the CLAT 2025 exam as well. This means that candidates belonging to any age group can apply for the law entrance exam",
            subject_1:'LEGAL REASONING  AND GK',
            subject_2:'ENGLISH ',
            subject_3:'LOGICAL REASONING ',
            subject_1_brief:'Contemporary events of national and international significance and  International affairs',
            subject_2_brief:' Correcting Incorrect Grammar Sentences, Active & Passive Voice',
        ...
        cuet:{
            name:'CUET',
            subheading:'The difficulty level of cracking the CUET exam can vary depending on individual perspectives and preparation strategies. While some consider it to be one of the easiest examinations, others find certain sections, such as Quantitative Aptitude, to be more challenging. Thorough preparation, time management, and a problem-solving mindset are crucial for success.',
            description:"Common University Entrance Test also known as CUET UG is a national level entrance exam conducted by NTA for admission to UG courses offered by participating institutes. Introduced in 2022, the CUET exam aligns as a significant UG entrance examination, offering candidates a common platform for seeking admission to UG programs in top colleges/universities throughout India. The exam is conducted once a year in over 500 cities in India and abroad. The exam is conducted in a computer-based mode.",
            criteria_1: "Candidates from the General category must have scored a minimum of 50% marks in their +2 examination. For SC/ST candidates, the minimum required marks are 45%.",
            criteria_2:" Applicants can apply for CUET while attempting the qualifying examination of the university. However, they will need to provide their passing certificate at the time of counseling.",
            criteria_3:"There is no specific age limit for appearing in the CUET 2024 exam. ",
        ...
        ipmat:{
            name:'IPMAT',
            subheading:'The difficulty level of cracking the IPMAT exam can vary depending on individual perspectives and preparation strategies. While some consider it to be one of the easiest examinations, others find certain sections, such as Quantitative Aptitude, to be more challenging. Thorough preparation, time management, and a problem-solving mindset are crucial for success.',
            description:"IPMAT is the Integrated Programme in Management Aptitude Test to admit students in their 5-year Integrated Programme in Management. It is designed for students who have completed their higher secondary education and wish to pursue a career in management after school. The exam assesses a candidate's aptitude in quantitative ability, verbal ability, logical reasoning, and proficiency in English language.",
            criteria_1: "Applicants must have scored a minimum of 60% aggregate in Class 10 and Class 12 or equivalent CGPA in the case of the General and NC OBC categories. Applicants belonging to SC, ST or PwD (DA) categories must have secured at least 55% aggregate or equivalent CGPA in Class 10 and Class 12",
            criteria_2:"Applicants must have passed the qualifying exam in the years 2023, 2024 or appearing in 2025.",
            criteria_3:"Applicants in the final year of Class 12 or awaiting the results are also eligible to apply provisionally.",
